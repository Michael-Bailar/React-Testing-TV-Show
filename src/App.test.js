...
import {render, getByTestId, getByAltText, waitFor, getByPlaceholderText} from '@testing-library/react'
import App from './App'
...
test('page loads without error', async () => {
    ...
    const {getByText, getByAltText, getByTestId, getByPlaceholderText} = render(<App />)
    getByText(/fetching data/i)
    // getByPlaceholderText
    await waitFor(()=> {
        expect(mockFetchShow).toHaveBeenCalledTimes(1)
        //find image loading correct
        getByAltText(/stranger things/i)
        //find title loading correct
        getByTestId('header-text')
        //description loads
        getByText(/A love letter to the '80s/i)
        //find dropdown loading correct.
